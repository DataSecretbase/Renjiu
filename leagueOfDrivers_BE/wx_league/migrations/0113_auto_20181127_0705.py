# Generated by Django 2.1.2 on 2018-11-27 07:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wx_league', '0112_auto_20181126_1813'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='book',
            name='coach',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coach_wechatuser', to=settings.AUTH_USER_MODEL, verbose_name='教练'),
        ),
        migrations.AlterField(
            model_name='coachdriverschool',
            name='coach',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='教练'),
        ),
        migrations.AlterField(
            model_name='coupons',
            name='goods_id',
