# Generated by Django 2.1 on 2018-09-11 17:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wx_league', '0088_auto_20180911_1657'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='goods',
            name='pic',
            field=models.IntegerField(verbose_name='商品图片连接'),
        ),
        migrations.AlterField(
            model_name='goods',
            name='shop_id',
            field=models.IntegerField(verbose_name='商店id'),
        ),
        migrations.AlterField(
