from django.core.validators import validator_email
...
class AccountSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = User
		fields = ('id','email','uername','major','bio','image','date_joined','updated_at','first_name','last_name','full_name','password','confirm_password')
	...
	def to_representation(self, obj):
		returnObj = super(AccountSerializert,self).to_representation(obj)
	...
	def update(self, instance, validated_data):
		...
		instance.magor = validated_data.get('major', instance.major)
...
class ViewerProfileTrackingSerializer(serializers.ModelSerializer):
