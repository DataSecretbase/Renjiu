# Generated by Django 2.1 on 2018-08-05 11:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wx_league.Attachment', verbose_name='图标')),
                ('pid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wx_league.Category', verbose_name='上级分类')),
            ],
            options={
                'db_table': 'Category',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wx_league.Attachment', verbose_name='图片')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=50, verbose_name='手机号码')),
                ('country', models.IntegerField(default=0, max_length=40, verbose_name='国家')),
                ('province', models.IntegerField(default=0, max_length=40, verbose_name='省份')),
                ('city', models.IntegerField(default=0, max_length=40, verbose_name='城市')),
        ...
        migrations.AddField(
            model_name='payment',
            name='wechat_user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wx_league.WechatUser', verbose_name='微信用户'),
        ),
        migrations.AddField(
            model_name='order',
            name='shipper_id',
